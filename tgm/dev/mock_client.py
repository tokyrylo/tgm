...
_BOB = User(
    ...
    bio="Backend engineer · Go & Rust",
    online=False,
    last_seen=_now - timedelta(minutes=7),
)
_CAROL = User(
    id="u3",
    name="Carol White",
...
_EVE = User(
    ...
    online=False,
    last_seen=_now - timedelta(days=1, hours=3),
)
_FRANK = User(
    id="u6",
    name="Frank Lee",
    ...
    bio="",
    online=False,
    last_seen=_now - timedelta(minutes=34),
)
_GRACE = User(
    id="u7",
    name="Grace Kim",
    ...
    bio="UX researcher @ Acme",
    online=True,
)

_USERS: dict[str, User] = {
    u.id: u for u in [_ME, _ALICE, _BOB, _CAROL, _DAVE, _EVE, _FRANK, _GRACE]
}
...
_CHANNELS: list[Channel] = [
    Channel(
        ...
        unread=5,
        pinned_message_id="g1-9",
    ),
    Channel(
        id="g2",
        name="random",
        topic="Off-topic, memes, water-cooler",
    ...
    Channel(
        id="g3",
        name="design-squad",
        topic="UI/UX feedback and assets",
        last_message="updated the mockups",
        unread=0,
    ),
    Channel(
        id="g4",
        name="ops-alerts",
        topic="Infra & incidents",
        last_message="deploy looks stable",
        unread=0,
    ),
    Channel(
        id="d1",
        ...
        is_dm=True,
        peer_user_id="u1",
        pinned_message_id="d1-5",
    ),
    Channel(
        id="d2",
        name="Bob Smith",
        topic="",
        last_message="yeah let me check",
        unread=0,
        is_dm=True,
        peer_user_id="u2",
    ),
    Channel(
        ...
        name="Eve Wilson",
        topic="",
        last_message="sounds fun, I'm in",
        unread=3,
        is_dm=True,
        peer_user_id="u5",
    ),
...
_MESSAGES: dict[str, list[Message]] = {
    ...
    "g1": [
        ...
        _msg(
            "g1-3",
            _DAVE,
            "anyone seen the latency spike from last night?",
            "g1",
            _t(hours=7, minutes=30),
        ),
        _msg(
            "g1-4",
            _BOB,
            "yeah, p99 hit 800ms around 2am. rolled back the cache change",
            "g1",
            _t(hours=7, minutes=20),
        ),
        _msg(
            "g1-5",
            _DAVE,
            "smart. we should add an alert for that",
            "g1",
            _t(hours=7, minutes=10),
        ),
        _msg(
            "g1-6", _ME, "on it, adding to the runbook too", "g1", _t(hours=7), out=True
        ),
        _msg(
            "g1-7",
            _ALICE,
            "btw new feature branch is ready for review",
            "g1",
            _t(hours=6),
        ),
    ...
    "g2": [
        ...
        _msg(
            "g2-2",
            _BOB,
            "HAHA the dependency graph one",
            "g2",
            _t(days=1, hours=2, minutes=50),
        ),
        _msg(
            "g2-3", _EVE, "so accurate it hurts", "g2", _t(days=1, hours=2, minutes=30)
        ),
        _msg(
            "g2-4",
            _ME,
            "our entire infra in one comic",
            "g2",
            _t(days=1, hours=2),
            out=True,
        ),
        _msg(
            "g2-5",
            _GRACE,
            "did anyone watch the Go keynote yesterday?",
            "g2",
            _t(days=1, hours=1),
        ),
        _msg(
            "g2-6",
            _ALICE,
            "bits of it, range over funcs is finally in?",
            "g2",
            _t(days=1, hours=0, minutes=50),
        ),
        _msg(
            "g2-7",
            _BOB,
            "only took 10 years lmao",
            "g2",
            _t(days=1, hours=0, minutes=40),
        ),
        _msg("g2-8", _EVE, "better late than never I guess", "g2", _t(days=1)),
        _msg(
            "g2-9",
            _FRANK,
            "anyone up for lunch today? the Thai place?",
            "g2",
            _t(hours=3),
        ),
        ...
        _msg(
            "g2-11",
            _GRACE,
            "can't, have a meeting till 2",
            "g2",
            _t(hours=2, minutes=40),
        ),
        ...
        _msg(
            "g2-14",
            _BOB,
            "this video of a cat debugging code is sending me",
            "g2",
            _t(hours=1, minutes=30),
            read=False,
        ),
    ...
    "g3": [
        _msg(
            "g3-1",
            _CAROL,
            "hey can someone review the new onboarding flow?",
            "g3",
            _t(days=2),
        ),
        ...
        _msg(
            "g3-4",
            _EVE,
            "looking now... the step 3 transition feels abrupt",
            "g3",
            _t(days=1, hours=20),
        ),
        ...
        _msg(
            "g3-7",
            _ME,
            "the color contrast on the CTA button also looks off on dark mode",
            "g3",
            _t(days=1, hours=10),
            out=True,
        ),
        _msg(
            "g3-8",
            _CAROL,
            "oh you're right, fixing that too",
            "g3",
            _t(days=1, hours=9),
        ),
    ...
    "g4": [
        _msg(
            "g4-1",
            _FRANK,
            "[ALERT] CPU spike on prod-worker-03 — 94%",
            "g4",
            _t(hours=12),
        ),
        _msg("g4-2", _DAVE, "on it", "g4", _t(hours=11, minutes=55)),
        _msg(
            "g4-3", _DAVE, "rogue cron job, killed it", "g4", _t(hours=11, minutes=40)
        ),
        _msg(
            "g4-4",
            _FRANK,
            "[RESOLVED] CPU back to normal",
            "g4",
            _t(hours=11, minutes=30),
        ),
        _msg("g4-5", _BOB, "nice catch", "g4", _t(hours=11)),
        _msg(
            "g4-6",
            _ME,
            "adding that job to monitoring",
            "g4",
            _t(hours=10, minutes=30),
            out=True,
        ),
        _msg(
            "g4-7",
            _FRANK,
            "[INFO] scheduled maintenance window tonight 11pm–1am UTC",
            "g4",
            _t(hours=6),
        ),
        ...
        _msg(
            "g4-11",
            _FRANK,
            "[INFO] maintenance complete, all services green",
            "g4",
            _t(hours=1),
        ),
    ...
    "d1": [
        _msg(
            "d1-1",
            _ALICE,
            "hey! are you coming to the team offsite next month?",
            "d1",
            _t(days=3),
        ),
        ...
        _msg(
            "d1-3",
            _ALICE,
            "nice, we should plan a hike on the Friday",
            "d1",
            _t(days=2, hours=20),
        ),
        _msg(
            "d1-4",
            _ME,
            "100%, I've been wanting to try that coastal trail",
            "d1",
            _t(days=2, hours=19),
            out=True,
        ),
        _msg(
            "d1-5",
            _ALICE,
            "same! also there's a good sushi place near the hotel",
            "d1",
            _t(days=2, hours=18),
        ),
        _msg(
            "d1-6",
            _ME,
            "bookmarked, let's go Thursday evening?",
            "d1",
            _t(days=2, hours=17),
            out=True,
        ),
        _msg(
            "d1-7",
            _ALICE,
            "perfect, I'll see if Bob and Carol want to join",
            "d1",
            _t(days=2, hours=16),
        ),
        ...
        _msg(
            "d1-9",
            _ALICE,
            "btw did you see the Q3 metrics? we're ahead of target 🎯",
            "d1",
            _t(hours=5),
        ),
        _msg(
            "d1-10",
            _ME,
            "yeah saw that, really solid work from the whole team",
            "d1",
            _t(hours=4, minutes=50),
            out=True,
        ),
        _msg(
            "d1-11", _ALICE, "agreed! catch up for coffee this week?", "d1", _t(hours=2)
        ),
        _msg(
            "d1-12",
            _ME,
    ...
    "d2": [
        _msg(
            "d2-1",
            _ME,
            "hey Bob, do you have the credentials for the staging DB?",
            "d2",
            _t(days=1, hours=4),
            out=True,
        ),
        ...
        _msg(
            "d2-3",
            _BOB,
            "check 1password vault 'staging-infra', should be there",
            "d2",
            _t(days=1, hours=3, minutes=40),
        ),
        _msg(
            "d2-4",
            _ME,
            "got it, thanks!",
            "d2",
            _t(days=1, hours=3, minutes=30),
            out=True,
        ),
        _msg(
            "d2-5",
            _BOB,
            "no prob. also heads up — I'm refactoring the auth module this week",
            "d2",
            _t(days=1, hours=3),
        ),
        _msg(
            "d2-6",
            _ME,
            "nice, let me know if you need a review",
            "d2",
            _t(days=1, hours=2, minutes=50),
            out=True,
        ),
        _msg(
            "d2-7",
            _BOB,
            "will do. btw the integration tests are flaky again 🙄",
            "d2",
            _t(hours=3),
        ),
        _msg(
    ...
    "d3": [
        ...
        _msg(
            ...
            "yes!! which trail?",
            "d3",
            _t(days=1, hours=1, minutes=50),
            out=True,
        ),
        _msg(
            "d3-3",
            _EVE,
            "thinking the ridge loop, about 12km",
            "d3",
            _t(days=1, hours=1, minutes=30),
        ),
        _msg(
            "d3-4",
            _ME,
            "perfect difficulty. Saturday or Sunday?",
            "d3",
            _t(days=1, hours=1),
            out=True,
        ),
        _msg(
            "d3-5",
            _EVE,
            "Saturday morning? meet at the trailhead at 8?",
            "d3",
            _t(days=1, hours=0, minutes=45),
        ),
        _msg(
            "d3-6",
            _ME,
        ...
        _msg(
            "d3-9",
            _EVE,
            "oh btw, Frank is joining too if that's ok?",
            "d3",
            _t(hours=2),
            read=False,
        ),
    ...
    "d4": [
        _msg(
            "d4-1",
            _GRACE,
            "hey, sent you the updated component library",
            "d4",
            _t(days=2, hours=3),
        ),
        _msg(
            ...
            "d4",
            _t(days=2, hours=2, minutes=50),
            out=True,
        ),
        _msg(
            "d4-3",
            _ME,
            "this looks great! especially the new button variants",
            "d4",
            _t(days=2, hours=2),
            out=True,
        ),
        _msg(
            "d4-4",
            _GRACE,
            "glad you like it! added accessibility improvements too",
            "d4",
            _t(days=2, hours=1, minutes=30),
        ),
        _msg(
            "d4-5",
            _ME,
            "noticed that, the focus rings are much cleaner",
            "d4",
            _t(days=2, hours=1),
            out=True,
        ),
        _msg(
            "d4-6",
            _GRACE,
            "thanks! I'll publish to npm once Carol signs off",
            "d4",
            _t(days=2),
        ),
        _msg(
            "d4-7",
            _ME,
            "sounds good, thanks for the hard work on this 🙏",
            "d4",
            _t(days=1, hours=23),
            out=True,
        ),
